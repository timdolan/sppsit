Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "SPPS Information Technology"
  ...
  config.menu_css = {:last=>"last", :first=>"first", :selected=>"selected"}

  # Should set this if concerned about DOS attacks. See
  # http://markevans.github.com/dragonfly/file.Configuration.html#Configuration
  # config.dragonfly_secret = "53193953e14c364a0f1b764a81eece494de15318cd4b212d"
  ...
  # config.wymeditor_whitelist_tags = {'tag' => 'font'}
